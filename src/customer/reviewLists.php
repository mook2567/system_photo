...
<body>
    ...
    <div class="container mt-5" style="height: 520px;">
        <h1 class="footer-title text-center f mt-3">ตารางรายการจองคิวที่ต้องรีวิว</h1>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#review">รีวิว</button>
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    <div class="modal fade" id="review" tabindex="-1" aria-labelledby="reviewLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="reviewLabel"><b><i class="fa-solid fa-pen"></i>&nbsp;&nbsp;เขียนรีวิว</b></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body" style="height: 600px;">
                    <div class="mt-3 container-md">
