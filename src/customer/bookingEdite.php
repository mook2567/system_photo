...
<body>
    ...
    <div class="mt-5 container-md">
        <div class="text-center" style="font-size: 18px;"><b><i class="fas fa-clipboard-list"></i>&nbsp;&nbsp;แก้ไขการจองคิว</b></div>
        <div class="mt-3 col-md-8 container-fluid">
            ...
            <div class="col-md-12 mt-3 text-center">
                ...
                <textarea name="dInformation_caption" class="form-control mt-1" placeholder="กรุณากรอกคำอธิบาย" style="resize: none; height: 100px;"></textarea>
            </div>
            <div class="col-12">
                <div class="row mt-3">
                    <div class="col-5">
