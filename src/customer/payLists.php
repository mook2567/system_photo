...
<body>
    ...
    <div class="container mt-5" style="height: 520px;">
        <h1 class="footer-title text-center f mt-3">ตารางรายการชำระเงิน/ค่ามัดจำ</h1>
        <div class="row justify-content-end table-responsive mt-3">
            <div class="col-md-4">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#pay">ทำการชำระ</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
                            ...
                            <div class="mt-3 col-md-12 container-fluid">
                                ...
                                <div class="col-12 mt-3 row">
                                    ...
                                    <div class="col-2 mt-3 ">
                                        <button type="submit" class="btn btn-warning btn-block mt-2" style="width: 150px;" data-bs-toggle="modal" data-bs-target="#pay">ทำการชำระ</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="pay" tabindex="-1" aria-labelledby="payLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="payLabel"><b><i class="fa-solid fa-file-invoice-dollar"></i>&nbsp;&nbsp;ชำระเงิน/ค่ามัดจำ</b></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body" style="height: 600px;">
                        <div class="mt-3 container-md">
                            <div class="mt-3 col-md-12 container-fluid">
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        ...
                                        <select id="payment-type" class="form-select border-1 mt-1 py-2">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select id="bank" class="form-select mt-1 border-1 py-2">
                                ...
                                <div class="row mt-5 text-center">
                                    <div class="col-md-12">
                                        <button name="saveButton" class="btn btn-primary" style="width: 150px; height:45px;">ยืนยันการชำระ</button>
                                    </div>
                                </div>
                            </div>
                        </div>
