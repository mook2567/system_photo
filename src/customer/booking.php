...
<body>
    ...
    <div class="mt-5 container-md">
        <div class="text-center" style="font-size: 18px;"><b><i class="fas fa-clipboard-list"></i>&nbsp;&nbsp;จองคิว</b></div>
        <div class="mt-3 col-md-8 container-fluid">
            ...
            <div class="col-12 mt-2">
                <div class="row">
                    <div class="col-md-3 text-center">
                        <label for="booking-start-date" style="font-weight: bold; display: flex; align-items: center;"><span style="color: black; margin-right: 5px;font-size: 13px;">วันที่เริ่มจอง</span><span style="color: red;">*</span></label>
                        <input type="date" name="booking-start-date" class="form-control" style="resize: none;">
                    </div>
                    <div class="col-md-2 text-center">
                        <label for="booking-start-time" style="font-weight: bold; display: flex; align-items: center;"><span style="color: black; margin-right: 5px;font-size: 13px;">เวลาเริ่มงาน</span><span style="color: red;">*</span></label>
                        <input type="time" name="booking-start-time" class="form-control" style="resize: none;">
                    </div>

                    <div class="col-md-3 text-center">
                        <label for="booking-end-date" style="font-weight: bold; display: flex; align-items: center;"><span style="color: black; margin-right: 5px;font-size: 13px;">วันที่สิ้นสุดการจอง</span><span style="color: red;">*</span></label>
                        <input type="date" name="booking-end-date" class="form-control" style="resize: none;">
                    </div>
                    <div class="col-md-2 text-center">
                        <label for="booking-end-time" style="font-weight: bold; display: flex; align-items: center;"><span style="color: black; margin-right: 5px;font-size: 13px;">เวลาสิ้นสุด</span><span style="color: red;">*</span></label>
                        <input type="time" name="booking-end-time" class="form-control" style="resize: none;">
                    </div>
                    <div class="col-2"><label for="date-saved" style="font-weight: bold; display: flex; align-items: center;">
                            <span style="color: black; margin-right: 5px;font-size: 13px;">วันที่บันทึก</span></label>
                        <input type="date" name="date-saved" class="form-control" style="resize: none;">
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 mt-2">
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <input type="text" name="location" class="form-control" placeholder="กรุณากรอกสถานที่" style="resize: none;">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12 mt-2 text-center">
                ...
                <textarea id="Information_caption" class="form-control" placeholder="กรุณากรอกคำอธิบาย" style="resize: none; height: 100px;"></textarea>
            </div>
            ...
            <div class="col-12">
                <div class="row mt-2">
                    <div class="col-5">
                        ...
                        <input type="text" name="mobile" class="form-control" placeholder="กรุณากรอกเบอร์โทร" style="resize: none; width: 90%;">
                    </div>
