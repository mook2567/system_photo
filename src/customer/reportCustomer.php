                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        <div class="nav-item dropdown">
                            <div class="nav-item dropdown">
                                <a href="booking.php" class="nav-link dropdown-toggle bg-dark " data-bs-toggle="dropdown">จองคิวช่างภาพ</a>
                                <div class="dropdown-menu rounded-0 m-0">
                                    <a href="pay.php" class="dropdown-item active">ชำระเงิน</a>
                                    <a href="PayDeposit.php" class="dropdown-item">รายการชำระค่ามัดจำ</a>
                                    <a href="review.php" class="dropdown-item">รีวิวช่างภาพ</a>
                                </div>
                            </div>
                        </div>
                        <a href="reportCustumer.php" class="nav-item nav-link active">รายงาน</a>
                        <div class="nav-item dropdown">
