...
<body>
    ...
    <div class="row mt-3">
        ...
        <!-- Edit Modal -->
        <div class="modal fade" id="editModal<?php echo $rowPhoto['photographer_id']; ?>" tabindex="-1" aria-labelledby="editModalLabel<?php echo $rowPhoto['photographer_id']; ?>" aria-hidden="true">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-9">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <div class="row">
                                                                                <div class="col-2 mt-2">
                                                                                    <label for="work_details_<?php echo $index; ?>" class="form-label">รายละเอียด:</label>
                                                                                </div>
                                                                                <div class="col-9">
                                                                                    <textarea id="work_details_<?php echo $index; ?>" name="work_details[<?php echo $index; ?>]" class="form-control" placeholder="Enter work details"><?php echo htmlspecialchars($rowTypeWorkDetail['type_of_work_details'], ENT_QUOTES, 'UTF-8'); ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
