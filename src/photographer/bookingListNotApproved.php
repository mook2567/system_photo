    ...
    <div class="center mt-5 container" style="height: 520px;">
        ...
        <div class="row justify-content-end">
            <div class="col-md-4">
                ...
                <button type="button" onclick="window.location.href='bookingListNotApproved.php'" class="btn btn-outline-dark active">ไม่อนุมัติ</button>
            </div>
        </div>
            ...
            <table class="table table-hover table-bordered-3">
                ...
                <tbody>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12">
                                                                    ...
                                                                    <div class="col-12 mt-2">
                                                                        <h6 class="f mt-3">หมายเหตุการไม่อนุมัติ</h6>
                                                                        <span style="color: black; margin-right: 5px;font-size: 18px;"><?php echo  $rowBooking['booking_note']; ?></span>
                                                                    </div>
                                                                </div>
                    ...
                    <?php
                        ...
                        echo "<tr><td colspan='6'>ไม่พบข้อมูลรายการปฎิเสธการอนุมัติ</td></tr>";
                    }
        ...
        <div class="row justify-content-center mt-3 container-center text-center">
            <div class="col-md-12"><br><br>
                <button onclick="window.history.back();" class="btn" style="background-color:gray; color:#ffff; width: 150px; height: 45px;">ย้อนกลับ</button>
            </div>
        </div>
    </div>
