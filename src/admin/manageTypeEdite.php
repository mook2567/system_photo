...
<body>
    ...
    <div class="mt-5 container-md ">
        <div class="text-center" style="font-size: 18px;"><b><i class="fas fa-file-alt"></i>&nbsp;&nbsp;แก้ไขข้อมูลประเภทงาน</b></div>
                        ...
                        <div class="card-body">
                            <form method="post" action="" enctype="multipart/form-data">
                                <div class="row mt-1 align-items-center">
                                    ...
                                    <center>
                                        <div class="col-3  mt-3 justify-content-center text-center ">
                                            <button type="submit" name="submit" class="btn btn-primary" style="width: 100%;">บันทึก</button>
                                        </div>
                                    </center>
                                </div>
                            </form>
