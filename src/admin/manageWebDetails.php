            ...
            <div class="col-12">
                <div class="row mt-2">
                    <div class="col-6">
                        ...
                        <input type="text" name="information_name" class="form-control mt-1" placeholder="กรุณากรอกชื่อ" value="<?php echo $row['information_name']; ?>">
                    </div>
                    <div class="col-6">
                        ...
                        <div class="">
                            <img src="../img/logo/<?php echo $row['information_icon']; ?>" alt="Your Image">
                        </div>
                    </div>
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="row mt-2">
                    <div class="col-12">
                        ...
                        <textarea name="information_caption" class="form-control mt-1" rows="5"style="resize: none;"><?php echo $row['information_caption']; ?></textarea>
                    </div>
                </div>
            </div>
        </div>
